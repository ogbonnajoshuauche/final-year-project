...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2019 at 06:20 AM
...
INSERT INTO `judgement` (`id`, `judgement_note`, `case_id`, `date`) VALUES
...
INSERT INTO `preceedings` (`preceeding_id`, `preceeding`, `status`, `case_id`, `member_id`, `date_of_preceeding`) VALUES
...
--
ALTER TABLE `preceedings`
  MODIFY `preceeding_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
